...
function createUserInfo(name, email) {
  ...
  var nameEl = createName(name);
  var emailEl = createEmail(email);
...
function createCard(id, name, email, avatarUrl) {
  ...
  section.id = "user-".concat(id);
  section.className = 'profile-card';
  var imgEl = createImg(avatarUrl, name);
  var userInfoEl = createUserInfo(name, email);
...
var _require = require('./dom'),
    createCard = _require.createCard; // The Profile class defines an Object template we'll use to work with profile data
...
var Profile = /*#__PURE__*/function () {
  ...
  function Profile(user) {
    ...
    this.id = user.id;
    this.name = "".concat(user.first_name, " ").concat(user.last_name);
...
},{"./dom":"dom.js"}],"app.js":[function(require,module,exports) {
...
function init() {
  ...
  .then(function (users) {
    ...
    users.forEach(function (user) {
      ...
      var profile = new Profile(user); // Use the Profile object to create a tree of DOM nodes

      var profileEl = profile.render(); // Append these DOM nodes to our document's main element
...
window.onload = init;
},{"./users":"users.js","./profile":"profile.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
